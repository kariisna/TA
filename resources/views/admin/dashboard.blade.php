    ...
    <aside id="sidebar" class="fixed top-0 left-0 z-40 h-screen w-64 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out bg-white shadow-lg">
        <div class="h-full px-3 py-4 flex flex-col">
            ...
            <nav class="flex-grow space-y-1">
                <a href="#" class="flex items-center px-4 py-3 text-gray-600 rounded-lg hover:bg-emerald-50 hover:text-emerald-600 group transition-colors">
                    <i class="fas fa-home w-5 h-5 mr-3"></i>
                    <span>Dashboard</span>
                </a>
                <a href="{{ route('admin.jadwal') }}" class="flex items-center px-4 py-3 text-gray-600 rounded-lg hover:bg-emerald-50 hover:text-emerald-600 group transition-colors">
                    <i class="fas fa-calendar-days w-5 h-5 mr-3"></i>
                    <span>Jadwal</span>
                </a>
                <a href="{{ route('admin.user') }}" class="flex items-center px-4 py-3 text-gray-600 rounded-lg hover:bg-emerald-50 hover:text-emerald-600 group transition-colors">
    ...
    <div class="lg:ml-64 min-h-screen p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <a href="{{ route('admin.create') }}" class="block text-center bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-2 px-4 rounded-lg transition-colors">
